...
:url-repo: https://github.com/hyperpolymath/asdf-cosign-plugin
...
image:https://img.shields.io/github/license/hyperpolymath/asdf-cosign-plugin?style=flat-square[License,link=LICENSE]
image:https://img.shields.io/github/v/release/hyperpolymath/asdf-cosign-plugin?style=flat-square[Release,link={url-repo}/releases]
image:https://img.shields.io/github/actions/workflow/status/hyperpolymath/asdf-cosign-plugin/ci.yml?branch=main&style=flat-square[Build Status,link={url-repo}/actions]
image:https://img.shields.io/badge/asdf-plugin-blue?style=flat-square[asdf Plugin,link={url-asdf}]

[.lead]
An {url-asdf}[asdf] plugin to install and manage {url-tool}[Cosign] versions.
...
Cosign is an upstream tool managed by this plugin. Refer to the official
...
|**Version Switching**
|Switch between Cosign versions per project

|**Project Isolation**
|Pin Cosign per repository via `.tool-versions`

|**Reproducible Builds**
|Align CI/CD and developer environments to the same Cosign version
...
=== Installing Cosign Versions

[source,bash]
----
asdf list all cosign
asdf install cosign latest
asdf install cosign 0.1.0
----
...
[source,bash]
----
asdf global cosign 0.1.0
asdf local cosign 0.1.0
asdf current cosign
cosign --version
----
...
* Ensure `cosign` is on PATH after installation.
* Verify the installed version with `cosign --version`.
